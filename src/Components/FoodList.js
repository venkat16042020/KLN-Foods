    ...
    <div className="food-list">
      ...
      {editingFood ? (
        <form className="edit-form" onSubmit={handleSubmit}>
          ...
          <button type="button" className="cancel-button" onClick={() => setEditingFood(null)}>Cancel</button>
        </form>
      ) : (
          ...
          <tbody>
            {foods.map((food) => (
              <tr key={food.id}>
                ...
                <td>
                  <button className="edit-button" onClick={() => handleEdit(food)}>Edit</button>
                  <button className="delete-button" onClick={() => handleDelete(food.id)}>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
